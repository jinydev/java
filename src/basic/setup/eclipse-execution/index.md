---
layout: basic
title: "5. 이클립스 소스 작성부터 실행"
nav_order: 5
parent: "개발 환경 구축"
grand_parent: "객체지향 자바 프로그래밍"
description: "5. 이클립스 소스 작성부터 실행 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "5. 이클립스 소스 작성부터 실행, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Execution`**: 익스큐션, 실행. (작성한 코드를 컴퓨터가 실제로 동작하게 만드는 과정)
*   **`Explorer`**: 익스플로러, 탐색기. (파일과 폴더 목록을 시각적으로 보여주는 창)
*   **`Console`**: 콘솔. (명령어를 치거나 프로그램의 텍스트 출력 결과를 보여주는 프로그램 하단의 검은 화면)
