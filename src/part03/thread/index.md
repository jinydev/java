...
has_children: true
parent: "라이브러리 활용"
description: "Chapter 20. 멀티 스레드 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "Chapter 20. 멀티 스레드, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
### [14.3 작업 스레드 생성과 실행](./03_worker-thread/)
...
### [14.6 스레드 동기화](./06_synchronization/)
...
### [14.10 가상 스레드](./10_virtual-thread/)

자바 21부터 정식 도입된 가상 스레드(Virtual Thread)는 기존의 운영체제 스레드(OS Thread)를 더 효율적으로 사용하기 위해 만들어진 경량 스레드입니다. 수천, 수만 개의 스레드를 적은 메모리 오버헤드로 쉽게 생성하고 관리할 수 있습니다.
