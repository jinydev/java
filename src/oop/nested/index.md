...
description: "Chapter 12. 중첩 선언과 익명 객체 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "Chapter 12. 중첩 선언과 익명 객체, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Nested Class`**: 네스티드 클래스, 중첩 클래스. (하나의 클래스 '둥지(Nest)' 안에 알을 품듯 또 다른 클래스를 고이 품어 선언해 놓은 독특한 형태)
*   **`Anonymous Object`**: 어노니머스 오브젝트, 익명 객체. (이름 없이 태어나 코드 한 줄에서 자신의 임무를 즉석으로 완수하고 흔적 없이 사라지는 일회용 객체)
