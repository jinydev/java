...
permalink: /oop/
description: "Part 02. 객체지향 프로그래밍 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "Part 02. 객체지향 프로그래밍, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
###  20. 디자인 패턴
- [20.1 Singleton Pattern](/oop/pattern/singleton)
- [20.2 Factory Method Pattern](/oop/pattern/factory-method)
- [20.3 Abstract Factory Pattern](/oop/pattern/abstract-factory)
- [20.4 Builder Pattern](/oop/pattern/builder)
- [20.5 Prototype Pattern](/oop/pattern/prototype)
- [20.6 Adapter Pattern](/oop/pattern/adapter)
- [20.7 Bridge Pattern](/oop/pattern/bridge)
- [20.8 Composite Pattern](/oop/pattern/composite)
- [20.9 Decorator Pattern](/oop/pattern/decorator)
- [20.10 Facade Pattern](/oop/pattern/facade)
- [20.11 Flyweight Pattern](/oop/pattern/flyweight)
- [20.12 Proxy Pattern](/oop/pattern/proxy)
- [20.13 Chain of Responsibility](/oop/pattern/chain-of-responsibility)
- [20.14 Command Pattern](/oop/pattern/command)
- [20.15 Interpreter Pattern](/oop/pattern/interpreter)
---
...
- [16.2 매개변수가 없는 람다식](/oop/lambda/no-parameter)
- [16.3 매개변수가 있는 람다식](/oop/lambda/parameter)
- [16.4 리턴값이 있는 람da식](/oop/lambda/return)
- [16.5 메소드 참조](/oop/lambda/method-reference)
- [16.6 생성자 참조](/oop/lambda/constructor-reference)
...
- [20.14 Command Pattern](/oop/pattern/command)
- [20.15 Interpreter Pattern](/oop/pattern/interpreter)
- [20.16 Iterator Pattern](/oop/pattern/iterator)
- [20.17 Mediator Pattern](/oop/pattern/mediator)
- [20.18 Memento Pattern](/oop/pattern/memento)
- [20.19 Observer Pattern](/oop/pattern/observer)
- [20.20 State Pattern](/oop/pattern/state)
- [20.21 Strategy Pattern](/oop/pattern/strategy)
- [20.22 Template Method Pattern](/oop/pattern/template-method)
- [20.23 Visitor Pattern](/oop/pattern/visitor)
...
*   **`Object-Oriented Programming (OOP)`**: 객체지향 프로그래밍. (프로그램을 단순한 명령어의 나열(절차)이 아니라, 서로 역할을 분담하고 협력하는 수많은 작은 부품(객체)들의 모임으로 파악하는 프로그래밍 패러다임)
*   **`Architecture`**: 아키텍처, 건축 양식. (건물의 뼈대와 기본 구조를 의미하듯, 소프트웨어를 구성하는 여러 컴포넌트 간의 상호작용과 전체적인 뼈대(구조)를 설계하는 것)
