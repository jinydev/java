...
*   **`Documentation`**: 도큐멘테이션, 문서화. (방대한 자바 세계에서 길을 잃지 않도록, 모든 클래스와 메소드의 사용법을 꼼꼼하게 정리해 놓은 개발자들의 영원한 백과사전 API 문서)
*   **`Deprecated`**: 디프리케이티드, 폐기 예정인. (문서를 보다 보면 종종 나타나며, "옛날엔 썼는데 버그도 있고 낡았으니 이제 웬만하면 다른 새 기능으로 갈아타세요"라고 친절하게 경고해 주는 단어)
