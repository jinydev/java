...
코딩에서 영어 단어의 의미만 정확히 이해해도 절반은 성공입니다! 오늘 배운 핵심 영단어들을 다시 한번 짚고 넘어갈 볼까요?

*   **`Review`**: 리뷰, 복습. (지금까지 배운 자바의 무기 창고(`java.base`) 속 `String`, `Math`, `System` 등 핵심 API 공구들의 사용법을 퀴즈를 풀며 손에 착 감기도록 길들이는 시간)
