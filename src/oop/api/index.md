---
layout: oop
title: "Chapter 15. 자바 기본 API (java.base)"
nav_order: 15
has_children: true
parent: "객체지향 자바 프로그래밍"
description: "Chapter 15. 자바 기본 API (java.base) 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "Chapter 15. 자바 기본 API (java.base), 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Base`**: 베이스, 기초, 기반. (자바 프로그램이 돌아가기 위해 없어서는 안 될 가장 핵심적이고 기본적인 부품들이 모여 있는 필수 모듈 `java.base`를 의미)
*   **`API (Application Programming Interface)`**: (어플리케이션 프로그래밍 인터페이스). (다른 개발자들이 미리 정교하게 잘 만들어둔 부품(클래스, 메소드)들을 내가 쉽게 가져다 쓸 수 있도록 열어둔 연결 통로/설명서)
