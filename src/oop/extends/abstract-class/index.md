...
description: "7.10 추상 클래스 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "7.10 추상 클래스, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Abstract`**: 앱스트랙트, 추상적인. (아직 구체화되지 않고 뼈대만 있는, 즉 '미완성'이라는 의미를 클래스나 메소드에 부여하는 키워드)
*   **`Override`**: 오버라이드, 재정의하다. (추상 클래스 부모님이 남겨둔 텅 빈 미완성 메소드(숙제)를 자식 클래스가 책임지고 강제로 완성해야 할 때 쓰는 어노테이션)
