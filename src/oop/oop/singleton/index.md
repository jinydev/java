...
description: "6.15 싱글톤 패턴 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "6.15 싱글톤 패턴, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Singleton`**: 싱글톤. (프로그램 전체를 통틀어 단 하나만 유일하게 존재해야 하는 특별한 객체를 만들 때 사용하는 전 국민 공유 객체 생성 기법)
*   **`Pattern`**: 패턴. (코딩을 하다 보니 자주 마주치는 뻔한 문제들을 쉽고 우아하게 해결하기 위해 선배 개발자들이 정립해 놓은 모범적인 코드 작성 뼈대나 공식)
