...
description: "6.9 인스턴스 멤버 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "6.9 인스턴스 멤버, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Instance Member`**: 인스턴스 멤버. (설계도가 아니라, 힙 메모리에 지어진 개별 아파트(객체)들마다 각자 거실에 따로따로 소유하고 있는 전용 변수나 기능들)
*   **`this`**: 디스. ('나 자신'. 지금 당장 코드를 피땀 흘려 실행하고 있는 바로 그 객체 주인의 메모리 주소를 가리키는 1인칭 단수 대명사)
