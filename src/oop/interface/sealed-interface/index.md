...
*   **`Sealed Interface`**: 실드 인터페이스, 봉인된 인터페이스. (아무나 내 인터페이스를 상속받거나 구현하지 못하도록, 자격 미달자들의 접근을 딱 막아버리는 최신 자바의 강력한 차단기)
*   **`Permits`**: 퍼미츠, 허용하다. (Sealed 인터페이스 바로 옆에 붙어서, "나를 상속받아도 되는 진짜 VIP 회원 명단은 오직 이 클래스들뿐이다!" 하고 점찍어주는 특별한 키워드)
