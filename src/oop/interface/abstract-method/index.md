...
description: "11.4 추상 메소드 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "11.4 추상 메소드, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Abstract Method`**: 추상 메소드. (이름과 매개변수 같은 껍데기만 있고 실제 실행할 내용물(코드)이 없는 텅 빈 메소드로, 자식 클래스에게 구체적인 구현을 강제하는 역할)
*   **`Implement`**: 임플리먼트, 구현하다. (인터페이스가 내린 지시사항(추상 메소드)의 빈칸 부분을 실제로 작동 가능한 코드를 짜서 완성해 내는 작업)
