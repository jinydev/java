...
description: "18.5 메소드 참조 에 대한 자바(Java) 기초 및 실전 프로그래밍 문서입니다."
keywords: "18.5 메소드 참조, 자바, Java, 프로그래밍, 백엔드, 개발, jinydev"
---
...
*   **`Method`**: 메소드, 방법. (클래스 안에 만들어둔 기능 덩어리)
*   **`Reference`**: 레퍼런스, 참조. (`Math::max` 처럼 람다식을 극한으로 줄여서, "내가 직접 안 하고 이미 있는 저 메소드가 알아서 처리하게 연결만 해줄게" 하고 중개인 역할만 하는 문법)
